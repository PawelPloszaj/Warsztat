    ...
    public partial class InitMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MechanicRepair", x => new { x.MechanicsId, x.RepairsId });
                    table.ForeignKey(
                        name: "FK_MechanicRepair_Mechanics_MechanicsId",
                        column: x => x.MechanicsId,
                        principalTable: "Mechanics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MechanicRepair_Repairs_RepairsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MechanicRepair_RepairsId",
                table: "MechanicRepair",
                column: "RepairsId");
